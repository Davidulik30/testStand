...
VALUES ('paylink', '{"transport": {"base_address": "https://payadap.co/api/v1/"}, "payment_methods": [{"id": "p2pcard", "name": "P2P Card", "required_fields": []}]}'),
 ...
 ('aplex', '{"transport": {"base_address": "http://5.129.242.10:8022/v1/"},"payment_methods": [{"id": "papara", "gtw_id": "657b6bafa93f477a573a66d0"}], "required_fields": []}');
...
VALUES ('paylink', 1, '{"credentials": {"api_key": "m9bb1lelXNK3c198UWb2e41J1EQM", "merch_id": "52161-b615-4211-8638-3998bdb806c0"}, "payment_methods": ["p2pcard"]}'),
 ...
 ('aplex', 5, '{"credentials": {"api_key": "6fO5obBS2qM6Q9IWwkhMQ2MD1emVB1aAtHwTAabSD0tBLZ9giDwRtXTJlaiKWh11==",  "secret_key": "FH1z1rjdTNQzWHGK7LvoqMLdN3UfZ7eF"}, "payment_methods": ["p2pcard"]}'),
