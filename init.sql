...
VALUES ('paylink', '{"transport": {"base_address": "https://payadap.co/api/v1/"}, "payment_methods": [{"id": "p2pcard", "name": "P2P Card", "required_fields": []}]}'),
 ...
 ('alpex', '{"transport": {"base_address": "http://185.230.143.210:8022"}}'),
 ('nestpay', '{"transport": {"base_address": "http://185.230.143.210:8023"}}');
...
VALUES ('paylink', 1, '{"credentials": {"api_key": "m9bb1lelXNK3c198UWb2e41J1EQM", "merch_id": "52161-b615-4211-8638-3998bdb806c0"}, "payment_methods": ["p2pcard"]}'),
 ...
 ('asupayme', 4, '{"credentials": {"api_key": "c2RmZHNhYnZmZGFiYWV0dnJ0c3JhZGZoYnN0cmRmdmJzZ2Z4MjM0NTQzZ2czcXZhZQ==", "merchant_id": "32", "secret_key": "superSecretKey228"}}'),
 ('alpex', 5, '{"credentials": {"login": "buyer@dev.alpex.app", "password": "dev", "webhook_url": "https://webhook.site/baf6db16-87eb-40df-b6b6-ebc44dc580a6"}}'),
 ('nestpay', 6, '{"credentials": {"client_id": "20001223", "currency": "944", "store_key": "stwr3c4v4n9liiryucfhf25520", "api_name": "toAdmin", "api_password": "TEMP000130432"}}');
